...
class LlamaJudge(BaseJudge):
    ...
    def __init__(self):
        # Initialize the router targeting the Llama2 provider
        self.router = LLMRouter("Llama2")
...
"""
        ...
        try:
            ...
            return {
                "success": False,
                "confidence": 0.0,
                "reason": f"Llama2 router failure: {e}",
                "judge": "Llama2",
                "available": False,
            }
        ...
        if not isinstance(result, dict):
            return {
                "success": False,
                "confidence": 0.0,
                "reason": "Llama2 returned non-dict output",
                "judge": "Llama2",
                "available": False,
            }
        ...
        if not text:
            return {
                "success": False,
                "confidence": 0.0,
                "reason": "Llama2 returned empty response body",
                "judge": "Llama2",
                "available": False,
            }
        ...
        try:
            ...
            return {
                "success": False,
                "confidence": 0.0,
                "reason": f"Llama2 invalid JSON output: {e}",
                "judge": "Llama2",
                "available": False,
            }